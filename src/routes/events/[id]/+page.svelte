    ...
    if(browser){
      ...
      for(let e of eventData){
        if(e.attributes.EventID == data.eventID){
          ...
          // PImage = attrs.PImage
          event = e.attributes
          console.log(e.attributes.FirstPlacePrize)
          setTimeout(() => {
            console.log(ThirdPlacePrize)
...
<div class="flex flex-col w-screen h-fit mt-10">
  ...
  <div class="flex items-center justify-center flex-col">
    ...
    <!-- Buttons -->
    {#if data.session}
    <div class=" w-screen px-[5vw] xl:px-[10vw] sm:grid sm:grid-cols-2 sm:justify-between mt-5">
        ...
        <div class= "flex items-center justify-center  w-[100%] max-sm:mt-5">
          {#if !data.needreg}
            <button class=" rounded-lg text-center w-[90%] p-2 bg-green-800 bg-clip-text text-transparent border-green-800 border-2" disabled>
    ...
    <!-- Landscape text -->
    <div class=" w-screen px-[5vw] xl:px-[10vw] flex flex-row mt-10 max-sm:hidden">
      <div class="w-[50vw] xl:w-[40vw] h-10 font-yatra flex-row flex items-center uppercase text-white">
        <div class=" flex flex-col items-start">
          <div class="text-[#FE786F] text-3xl md:text-4xl lg:text-5xl xl:text-6xl">
            {event.Heading}
          </div>
      ...
      <div class="w-[50vw] xl:w-[40vw] h-10 flex  text-white flex-row-reverse items-center"> 
        {#if ThirdPlacePrize}
