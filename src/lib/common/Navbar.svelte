...
<div id="nav-container" class=" w-screen md:sticky max-md:fixed max-md:top-0 z-10">
    ...
    <div id="coverall" class=" overscroll-contain fadeIn max-md:hide max-md:h-screen w-screen fixed z-[8] max-md:backdrop-blur-md max-md:top-0 max-md:left-0 md:pointer-events-none max-md:fadeIn max-md:hidden overflow-hidden">
